...
if($pwd==$cpwd)
{
$query="insert into tbl_register(firstname,lastname,email,password,phone,address,cid,sid,ctid,added_date_time) values('$fnm','$lnm','$em','$pwd','$phone','$add','$cn','$st','$ct','$reg_date')";
$exe=mysqli_query($con,$query);
echo "<script>
