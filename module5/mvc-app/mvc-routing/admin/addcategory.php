...
<input type="text" name="categoryname" placeholder="Enter Category *" data-bvalidator="required" class="form-control"/>
</div>
<div class="form-group mt-3">
<textarea name="categorydesc"  placeholder="Enter Category descriptions *" data-bvalidator="required" class="form-control"></textarea>
</div>
<div class="form-group mt-3">
