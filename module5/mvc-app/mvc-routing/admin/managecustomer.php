...
<div class="row">
<h3 class="ms-4">Manage All Customers <span class="bi bi-person"></span></h3>
...
<div class="col-md-12 ms-4 bg-white shadow p-4 mt-4">
 <table class="table table-responsive">
    ...
    <tbody>
        <tr>
            <td>1001</td>
            <td><img src="https://media.istockphoto.com/id/639085642/vector/user-sign-icon-person-symbol-human-avatar.jpg?s=612x612&w=0&k=20&c=n4Zr1A7GMVTY8rZztu_OnMQ4_dkLBLRRAcTb0IIbQfY=" class="img-fluid" style="width: 85px; height: 85px;" /></td>
            <td>Nupur patel</td>
