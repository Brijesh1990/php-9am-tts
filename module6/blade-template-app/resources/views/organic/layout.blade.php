...
<html lang="en">
  <head>
    <title>Organic - Grocery Store | contact us | 998003879 | @yield('title-here')</title>
    <meta charset="utf-8">
        ...
        <div class="row py-3 border-bottom">
          ...
          <div class="col-sm-4 col-lg-2 text-center text-sm-start d-flex gap-3 justify-content-center justify-content-md-start">
            <div class="d-flex align-items-center my-3 my-sm-0">
              <a href="index.html">
                <img src="{{asset('assets/user/images/logo.svg')}}" alt="logo" class="img-fluid">
              </a>
            </div>
          ...
          <div class="col-lg-4">
            <ul class="navbar-nav list-unstyled d-flex flex-row gap-3 gap-lg-5 justify-content-center flex-wrap align-items-center mb-0 fw-bold text-uppercase text-dark">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle pe-3" role="button" id="pages" data-bs-toggle="dropdown" aria-expanded="false">All Pages</a>
                <ul class="dropdown-menu border-0 p-3 rounded-0 shadow" aria-labelledby="pages">
                  <li><a href="/about-us" class="dropdown-item">About Us </a></li>
                  <li><a href="/all-products" class="dropdown-item">Shop </a></li>
                  <li><a href="/view-cart" class="dropdown-item">Cart </a></li>
                  <li><a href="/checkout" class="dropdown-item">Checkout </a></li>
                  <li><a href="/our-blogs" class="dropdown-item">Blog </a></li>
          ...
          <div class="col-sm-8 col-lg-2 d-flex gap-5 align-items-center justify-content-center justify-content-sm-end">
            <ul class="d-flex justify-content-end list-unstyled m-0">
              <li>
                <a href="/create-account" class="p-2 mx-1">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer-menu">
              <img src="{{asset('assets/user/images/logo.svg')}}" width="240" height="70" alt="logo">
